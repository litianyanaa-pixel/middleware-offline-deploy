...
VALUES (1, 'admin', 'c8c1132e7428ba5b68a8ccb08a55fdf5493357fd36b124ed2d2f53e1b77bf4f6', 1, NULL);

INSERT INTO `xxl_job_lock` (`lock_name`)
VALUES ('schedule_lock');

ALTER TABLE xxl_job_group ADD COLUMN `title` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '执行器名称';

ALTER TABLE xxl_job_info ADD COLUMN `job_desc` VARCHAR(255) NOT NULL DEFAULT '' COMMENT '任务描述';
